...
function cssAutoDetect() {
    var lrSpecificItem = $(rowReverse).children(specificItem);
    var lrItem = $(rowReverse).children(rowChild);

    if (lrSpecificItem.hasClass("text-left")) {
        lrSpecificItem.removeClass("text-left")
    } else {
        lrSpecificItem.addClass("text-left")
    }
}
